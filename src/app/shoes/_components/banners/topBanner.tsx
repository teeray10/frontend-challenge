export default function TopBanner() {
  return (
    <section className="bg-summer-sale bg-center bg-no-repeat flex justify-between items-center text-white font-suez px-2 py-3 mt-2 lg:mt-0 lg:w-[890px] lg:mx-auto lg:gap-64 lg:pl-10 text-nowrap">
      <div>
