...
export default function AddToCart() {
  ...
  return (
    <div className="bg-lightest_grey p-5">
      ...
      <SelectBox items={sizes} isMulti={false} placeholder="SELECT SIZE"/>
      ...
      <button className="bg-blue text-white font-suez lg:text-xl xl:text-3xl p-5 text-nowrap mx-auto flex items-center gap-3 w-fit">
