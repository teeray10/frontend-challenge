...
export default function MailingList() {
  return (
    <div className="bg-blue text-white flex flex-col items-center gap-4 py-5 px-7 relative lg:ml-5">
      ...
      <div className="w-full">
        <p className="ml-3 mb-1 font-bold text-sm">EMAIL</p>
        <input type="text" placeholder="ENTER EMAIL ADDRESS" className="w-full py-2 px-3" />
      </div>
