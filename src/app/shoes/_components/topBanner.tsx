export default function TopBanner() {
  return (
    <section className="bg-summer-sale bg-no-repeat flex justify-between lg:justify-start items-center text-white font-suez px-2 py-3 lg:mt-0 lg:pl-10 text-nowrap">
      <div>
