export default function SubHeader() {
  return (
    <section className="bg-lightest_grey font-suez text-grey flex flex-col justify-center items-center w-full gap-5 py-5 col-span-full lg:gap-96 lg:flex-row">
